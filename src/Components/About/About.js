  ...
  return (
    <section>
      ...
      <section id='about-container'>
        ...
        <Sports />
        <p className='personal-two'>Throughout my career I have gained experience in constructing equipment, engineering, and problem solving which bleeds into my personal life and has led me to become an avid hobbyist. There is an endless amount of skills I wish to learn, to the extent that my focus can quickly shift from one concept to the next. RIP abandoned ideas. I look forward to my career as a software developer and I am excited to continue to solve problems and challenge myself everyday.
        </p>
      </section>
      <Footer />
    </section>
