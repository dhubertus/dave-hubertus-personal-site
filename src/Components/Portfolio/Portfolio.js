      ...
      <section id='portfolio-card-container'>
        ...
        <article className='project-card'>
          ...
          <a
            ...
            target='_blank'>UFO Sightings GitHub Repository</a>
          <div id='ufo-img'>
            <p>HOVER</p>
          </div>
        </article>
        <article className='project-card'>
          ...
          <a
            ...
            target='_blank'>Movie Tracker GitHub Repository</a>
        ...
        <article className='project-card'>
          ...
          <a
            ...
            target='_blank'>Star Wars API GitHub Repository</a>
        ...
        <article className='project-card'>
          ...
          <a
            ...
            target='_blank'>CloudKicker GitHub Repository</a>
        ...
        <article className='project-card'>
          ...
          <a
            ...
            target='_blank'>Breakout GitHub Repository</a>
          <div id='breakout-img'>
            <p>HOVER</p>
          </div>
        </article>
